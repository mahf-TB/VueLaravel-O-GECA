<template>
  <div
    class="fixed flex flex-col justify-between top-14 left-0 w-25  md:w-56 md:flex hidden  bg-green-pri h-full text-white transition-all duration-300 border-none z-10 "
    id="sideNav">
    <nav>
      <ul class="space-y-3">
        <li class=" px-2">
