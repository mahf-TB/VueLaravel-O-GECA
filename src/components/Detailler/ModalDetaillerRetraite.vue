...
export default {
    ...
    methods: {
       async open() {
            this.visible = true
            try {
                const response = await  Axios.get(`/indexDetailleRetraite/${this.id}`)
                ...
                corps: data.corps,
                grade: data.grade,
                dernier_avance: data.date_naissance,
                prochaine_avance: data.date_retrait,
