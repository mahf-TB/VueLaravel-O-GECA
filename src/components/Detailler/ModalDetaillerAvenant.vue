        ...
        <Dialog v-model:visible="visible" modal header="Information sur un agent" :style="{ width: '70rem' }"
            ...
            <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                <div class="flex">
                    <div class="w-full">
                        <!-- matricule -->
                        <label for="mat" class="text-gray-800 text-sm  uppercase font-bold leading-tight tracking-normal">
                ...
                <div class="flex">
                    <!-- nom -->
                    <div class="w-full">
                        <label for="name1" class="text-gray-800 uppercase  text-sm font-bold leading-tight tracking-normal">
                ...
                <div class="flex">
                    ...
                    <div class="w-full">
                        <label for="name1" class="text-gray-800 uppercase text-sm font-bold leading-tight tracking-normal">
                           date du Dernière Avancement <span class="text-red-500">*</span></label>
                        <h4
                            class="mb-5 mt-2 text-gray-600 focus:outline-none focus:border  font-normal w-full h-10 flex items-center pl-3 text-sm bg-gray-200  border-gray-100 rounded border">
                    ...
                    <!-- prenom -->
                    <div class="w-full ml-1">
                        <label for="name2" class="text-gray-800 uppercase text-sm font-bold leading-tight tracking-normal">
                           date du Prochaine Avancement</label>
                        <h4
                            class="mb-5 mt-2 text-gray-600 focus:outline-none focus:border  font-normal w-full h-10 flex items-center pl-3 text-sm bg-gray-200  border-gray-100 rounded border">
