            ...
            <div class="flex justify-between max-md:flex-col">
                ...
                <div class="text-right  h-10">
                    <button @click.prevent="enregistrement()"
                        class="bg-green-pri hover:bg-cyan-600 text-white font-semibold py-2 px-4 mb-5 rounded">
                        Ajouter
                    </button>
                </div>
            </div>
            ...
            <table class="w-full table-auto text-sm">
                ...
                <tbody>
                    <tr class="hover:bg-grey-lighter">
                        <td class="py-2 px-4 border-b border-grey-light">11434</td>
                        <td class="py-2 px-4 border-b border-grey-light">Baba</td>

                        <td class="py-2 px-4 border-b border-grey-light">Zizou</td>

                        <td class="py-2 px-4 border-b border-grey-light">babazizou@gmail.com</td>

                        <td class="py-2 px-4 border-b border-grey-light">RH</td>
                        <td class="py-2 px-4 border-b border-grey-light text-right">22/11/2023</td>
                    </tr>
                </tbody>
            </table>
